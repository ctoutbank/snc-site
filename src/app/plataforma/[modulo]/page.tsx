        ...
        {m.useCases && m.useCases.length > 0 && (
          <section style={{ background: 'var(--snc-paper-2)', borderTop: '1px solid rgba(15,26,36,.1)', padding: '80px 28px' }}>
            <div style={{ maxWidth: 1180, margin: '0 auto' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: 1, background: 'radial-gradient(circle, rgba(15,26,36,.18) 1px, #F4EFE4 1px) center/14px 14px', border: '1px solid rgba(15,26,36,.12)' }}>
                {m.useCases.map((uc, i) => (
        ...
        {m.datasetItems && m.datasetItems.length > 0 && (
          <section className="snc-sec" style={{ paddingTop: 72, paddingBottom: 72, borderTop: '1px solid rgba(15,26,36,.1)' }}>
            <div style={{ maxWidth: 1180, margin: '0 auto' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: 1, background: 'radial-gradient(circle, rgba(15,26,36,.18) 1px, #F4EFE4 1px) center/14px 14px', border: '1px solid rgba(15,26,36,.12)' }}>
