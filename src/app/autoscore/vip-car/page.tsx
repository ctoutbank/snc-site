...
export const metadata: Metadata = {
  title: "Relatório Veicular Completo do Veículo — SNC",
  description:
    "Relatório veicular completo do veículo: identificação, proprietário, restrições, débitos, sinistros, recalls, leilões e histórico FIPE.",
};
          ...
          <div className="busca-panel-inner">
            ...
            <div className="busca-header-compact">
              <div className="snc-mono sub-meta">
                DATASET 01 · RELATÓRIO VEICULAR COMPLETO · PLACA · LGPD ART. 7º III
              </div>
              <h1 className="busca-title-compact">
                Relatório Veicular <span className="gold">Completo</span>
              </h1>
