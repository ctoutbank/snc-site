...
const DATASETS = [
  {
    id: "00",
    titulo: "SNC AutoScore (Premium)",
    subtitulo: "Veículos · Super-Relatório",
    descricao: "O mais completo relatório veicular unificado do mercado. Combina BIN cadastral, proprietário, restrições detalhadas (Gravames/CNJ), débitos consolidados, histórico de quilometragem e leilão com score de risco.",
    campos: ["BIN / Ficha", "Proprietário", "Restrições B3/CNJ", "Débitos DETRAN", "KM / Hodômetro", "Leilão Score"],
    status: "ativo" as const,
    href: "/autoscore/snc-autoscore",
    cor: "#D4A843",
    corBg: "rgba(212,168,67,0.06)",
  ...
  },
  {
    ...
    subtitulo: "Veículos · Placa",
    descricao: "Consulta consolidada de características cadastrais do veículo: marca, modelo, ano, chassi, renavam, motor, cor e combustível em uma única consulta rápida.",
    campos: ["Marca / Modelo", "Ano Fab / Mod", "Chassi", "RENAVAM", "Motor", "Cor / Combustível"],
    status: "ativo" as const,
    font: "agregados-basica",
    href: "/autoscore/agregados-basica",
    cor: "#D4A843",
    corBg: "rgba(212,168,67,0.05)",
    corBorder: "rgba(212,168,67,0.15)",
    fonte: "DENATRAN / SENATRAN",
  ...
  },
  {
    ...
    subtitulo: "Veículos · Placa",
    descricao: "Consulta cadastral primária e identificadores estruturais a partir de base proprietária unificada: marca, modelo, chassi, renavam, motor, cor e combustível.",
    campos: ["Marca / Modelo", "Ano Fab / Mod", "Chassi", "RENAVAM", "Motor", "Cor / Combustível"],
    status: "ativo" as const,
    href: "/autoscore/agregados-propria",
    cor: "#D4A843",
    corBg: "rgba(212,168,67,0.05)",
    corBorder: "rgba(212,168,67,0.15)",
    fonte: "DENATRAN / SENATRAN",
  ...
  },
  {
    ...
    subtitulo: "Veículos · Chassi",
    descricao: "Decodifique o chassi e obtenha dados cadastrais completos: marca, modelo, ano, placa vinculada, renavam, motor, dados técnicos (espécie, tipo, carroceria, potência, cilindrada) e procedência.",
    campos: ["Marca / Modelo", "Ano Fab / Mod", "Placa Vinculada", "RENAVAM", "Motor", "Dados Técnicos"],
    status: "ativo" as const,
    href: "/autoscore/agregados-chassi",
    cor: "#D4A843",
    corBg: "rgba(212,168,67,0.05)",
    corBorder: "rgba(212,168,67,0.15)",
    fonte: "DENATRAN / SENATRAN",
  ...
  },
  {
    ...
    subtitulo: "Veículos · Agrupados",
    descricao: "Consulta veicular completa: ficha cadastral com dados técnicos, agregados/chassi, proprietário atual e tabela FIPE com valor de mercado — tudo em uma única busca.",
    campos: ["Ficha Cadastral", "Agregados/Chassi", "Proprietário Atual", "Tabela FIPE"],
    status: "ativo" as const,
    href: "/autoscore/veicular-agrupados",
    cor: "#D4A843",
    corBg: "rgba(212,168,67,0.05)",
    corBorder: "rgba(212,168,67,0.15)",
