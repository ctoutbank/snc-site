...
const DATASETS = [
  ...
  },
  {
    ...
    subtitulo: "Veículos · Placa",
    descricao: "Relatório completo do veículo: proprietário, restrições, débitos, sinistros, recalls, leilões e histórico FIPE.",
    campos: ["Proprietário", "Restrições", "Débitos", "Sinistros", "Recalls", "Leilões", "FIPE"],
    status: "ativo" as const,
    href: "/busca/vip-car",
    cor: "#7B5EA7",
  ...
  },
  {
    ...
    subtitulo: "Veículos · Placa",
    descricao: "Histórico de leilão e score de risco do veículo. Identifique se o veículo já passou por leilão e avalie o grau de risco.",
    campos: ["Score", "Risco", "Total Leilões", "Histórico", "Leiloeiro", "Condição"],
    status: "ativo" as const,
