...
const DATASETS = [
  ...
  {
    id: "03",
    titulo: "CPF · Dados Cadastrais",
    subtitulo: "Pessoa Física · CPF",
    descricao: "Situação cadastral, nome, data de nascimento e status na Receita Federal.",
    campos: ["Situação Receita", "Nome", "Data Nascimento", "Óbito"],
