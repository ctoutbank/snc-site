...
export const JOURNEYS: SncJourney[] = [
  ...
  },
  {
    ...
    narrative: [
      ...
      'O SNC conecta, em uma única chamada de API, os módulos que precisam operar juntos: varredura automática PLD/FT em COAF, OFAC, ONU, UE e Interpol; identificação e monitoramento contínuo de Pessoas Politicamente Expostas com graus de relacionamento familiar e societário; análise de exposição política com histórico de cargos, doações eleitorais e bens declarados; trilha de auditoria imutável exportável como evidência para Relatórios de Inteligência Financeira. Cada etapa é logada por obrigação regulatória, não por consulta genérica.',
      'Para fintechs, bancos, IAPs e qualquer empresa com obrigação regulatória, o resultado é direto: conformidade verificável, não apenas declarada. Sua área de compliance para de operar no modo reativo. A evidência de cada decisão está estruturada desde o primeiro onboarding, e a exposição em fiscalizações cai a zero.',
    ],
    paraQueServe: [
      'Instituições financeiras que precisam demonstrar conformidade ao Banco Central em auditorias e inspeções',
      'Fintechs em processo de licenciamento que precisam ter a infraestrutura PLD/FT operacional desde o dia zero',
      'Empresas com obrigação de reporte ao COAF que precisam de log estruturado e rastreável por operação',
      'Escritórios de compliance e assessorias jurídicas que precisam de evidência documental para seus clientes',
      'Fundos de investimento e gestoras com obrigação de KYC e monitoramento contínuo de cotistas',
    ],
    steps: [
...
export const SECTORS: SncSector[] = [
  ...
  },
  {
    ...
    description: 'Antifraude, phone score e perfil digital para operações de alto volume.',
  ...
  },
  {
    ...
    size: 'sz-6',
    image: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=900&q=80',
    description: 'Underwriting preciso com identidade, risco e histórico financeiro integrados.',
  ...
  },
  {
    ...
    description: 'SICAR, IBAMA, CAR e ESG integrados para financiamento rural seguro.',
  ...
  },
  {
    ...
    description: 'Score multibureau e detecção de SIM swap para toda a operação.',
  ...
  },
  {
    ...
    description: 'Indicadores empresariais, ESG e IBAMA para validar fornecedores em escala.',
  ...
  },
  {
    ...
    description: 'Background check e validação documental automáticos para plataformas.',
  ...
  },
  {
    ...
    description: 'Certidões, PEP e compliance público consolidados numa consulta.',
  ...
  },
  {
    ...
    description: 'Vetting de motoristas com antecedentes, CNH e RAIS integrados.',
  ...
  },
  {
    ...
    description: 'Score de crédito e monitoramento de adimplência para utilities reguladas.',
  ...
  },
  {
    ...
    description: 'KYC regulatório, PEP, idade e risco financeiro para operadores licenciados.',
